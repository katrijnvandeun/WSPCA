...
%expression data
load ../R/GSE29614/rawdata/GSE29614_rma.txt;
DATA=GSE29614_rma;

%antibody titers
load ../DATA/TIVtiters_2007.txt
TITERS=TIVtiters_2007;

%pheno data:
fid=fopen('../R/GSE29614/rawdata/GSE29614_pdata.txt');
...
save ../DATA/DATA2007_std.txt DATA_diffD3_std -double -ascii;
save ../DATA/DATA2007.txt DATA_diffD3 -double -ascii;
save ../DATA/DATA2007_std DATA_diffD3_std;
save ../DATA/DATA2007 DATA_diffD3;
save ../DATA/DATA_D0_2007 DATA_D0;
save ../DATA/DATA_D3_2007 DATA_D3;
save ../DATA/TIVtiter2007 Y;
save ../DATA/TIVtiter2007.txt Y -double -ascii;